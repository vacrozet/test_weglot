...
describe("Test unitaires pour la fonction findMeetingTime", () => {
  ...
  it("Test avec reunion 'surprise' intercalés et impossibilité de caser une reunion", () => {
    const schedules = [
      "1 15:00-15:09",
      "1 14:00-15:29",
      "1 08:00-09:00",
  ...
  // integration de mock -- InProgess
  it.only("Test de base avec des horaires disponibles", () => {
    expect.assertions(2);
    const schedules = parseFileToTable("./data/input1.txt");
    expect(findMeetingTime({ dataInput: schedules })).toBe("1 13:00-13:59");
  });
